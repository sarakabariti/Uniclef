...
class Category(models.Model):
    category_tag = models.CharField(max_length=25)
...
class Course(models.Model):
    ...
    duration = models.PositiveIntegerField(validators=[MinValueValidator(1), MaxValueValidator(25)])  # Duration in weeks
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(15)])
